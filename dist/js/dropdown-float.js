class DropdownFloat {
  ...
  static toggleDropdown(dropdown, button) {
    DropdownFloat.isOpen(dropdown) ? DropdownFloat.closeDropdown(dropdown, button) : DropdownFloat.openDropdown(dropdown, button);
  }
  ...
  static destroy() {
    ...
    DropdownFloat._rafPending = /* @__PURE__ */ new WeakMap();
