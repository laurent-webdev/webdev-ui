export default class Dropdown {
    ...
    static toggleDropdown(dropdown, button) {
        Dropdown.isOpen(dropdown)
            ...
            : Dropdown.openDropdown(dropdown, button);
    }
    ...
    static updateTriggers(dropdown, expanded) {
        document.querySelectorAll(`[data-ui="dropdown"][data-target="#${dropdown.id}"]`)
    ...
    static openDropdown(dropdown, button) {
        ...
        // Mémoriser les préférences originales une seule fois à l'ouverture
        ...
        const checkViewport = () => {
            ...
            const centerFits =
                (buttonRect.left + buttonRect.width / 2) - dropdownWidth / 2 >= 0
                && (buttonRect.left + buttonRect.width / 2) + dropdownWidth / 2 <= window.innerWidth;
    ...
    static closeDropdown(dropdown, button) {
        ...
        const cleanup = () => {
            ...
            // Restaurer la préférence originale et nettoyer
            if (wrapper) {
        ...
        // Prendre la durée max parmi toutes les transitions
